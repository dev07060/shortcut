...
class _$SignedInImpl implements SignedIn {
  ...
  @override
  String toString() {
    return 'Auth.signedIn(id: $id, displayName: $displayName, email: $email, token: $token)';
  }
...
abstract class SignedIn implements Auth {
...
abstract class SignedOut implements Auth {
